...
const OVERRIDES: Record<string, string> = {
  ...
  'филе бедра': 'Куриное филе бедра сырое',
  'бедро куриное': 'Бедро куриное сырое',
  'бёдра на кости': 'Бедро куриное сырое',
  ...
  морковь: 'Морковь',
  горчица: 'Горчица',
  'дижонская горчица': 'Горчица',
  бульон: 'Бульон говяжий',
  'говяжий бульон': 'Бульон говяжий',
  'куриный бульон': 'Бульон куриный',
  свинина: 'Свинина бескостная',
  'свиной фарш': 'Свинина бескостная',
  пассата: 'Перетёртые томаты',
  'протёртые томаты': 'Перетёртые томаты',
  'красное вино': 'Вино сухое красное',
  ...
  'белое вино': 'Вино сухое белое',
  'сухое белое вино': 'Вино сухое белое',
  чили: 'Перец чили',
  'перец чили': 'Перец чили',
  'перец горошком': 'Перец чёрный горошком',
  'чёрный перец горошком': 'Перец чёрный горошком',
  оливки: 'Оливки',
...
const DISH_OVERRIDES: Record<string, string[]> = {
  ...
  pasta: ['Макароны Linguine 280 г', 'Соль 2 г'],
  mash: [
    'Картофель 620 г',
    'Молоко 2,5% 70 г',
  ...
  bolognese: [
    'Говядина бескостная 250 г',
    'Свинина бескостная 200 г',
    'Лук репчатый 150 г',
    'Морковь 100 г',
  ...
  beef_pork_cutlets: [
    'Говядина бескостная 350 г',
    'Свинина бескостная 250 г',
    'Лук репчатый 100 г',
  ...
  chicken_meatballs: [
    'Филе грудки куриное сырое 300 г',
    'Куриное филе бедра сырое 300 г',
    'Лук репчатый 300 г',
    'Чеснок 10 г',
    'Яйцо куриное 55 г',
